...
) ENGINE=InnoDB AUTO_INCREMENT=73252157 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `articulos` VALUES (1,27,NULL,NULL,NULL,NULL,'fddfgdfgdfg',1,1,1,NULL,3,'fgfdg',1,'Bulto(s)',NULL,'gabrielt@donyeyo.com.ar','');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`DBAdmin_Acceso_A_Planta`@`%`*/ /*!50003 TRIGGER `trg_art_before_insert` BEFORE INSERT ON `articulos` FOR EACH ROW BEGIN
    SET NEW.id = NULL;
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`DBAdmin_Acceso_A_Planta`@`%`*/ /*!50003 TRIGGER `trg_art_ins` AFTER INSERT ON `articulos` FOR EACH ROW INSERT INTO `auditoria`
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`DBAdmin_Acceso_A_Planta`@`%`*/ /*!50003 TRIGGER `trg_art_upd` AFTER UPDATE ON `articulos` FOR EACH ROW INSERT INTO `auditoria`
  (`entidad`, `idEntidad`, `usuario`, `vigilador`, `operacion`, `evento`, `modulo`)
VALUES
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`DBAdmin_Acceso_A_Planta`@`%`*/ /*!50003 TRIGGER `trg_art_del` BEFORE DELETE ON `articulos` FOR EACH ROW INSERT INTO `auditoria`
  (`entidad`, `idEntidad`, `usuario`, `vigilador`, `operacion`, `evento`, `modulo`)
VALUES
...
CREATE TABLE `documentos` (
  ...
  `idEstado` int NOT NULL,
  `tipo` enum('Remito','Factura','Presupuesto','Orden de compra','Otros') NOT NULL,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`DBAdmin_Acceso_A_Planta`@`%`*/ /*!50003 TRIGGER `trg_doc_before_insert` BEFORE INSERT ON `documentos` FOR EACH ROW BEGIN
    SET NEW.id = NULL;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`DBAdmin_Acceso_A_Planta`@`%`*/ /*!50003 TRIGGER `trg_doc_ins` AFTER INSERT ON `documentos` FOR EACH ROW INSERT INTO `auditoria`
  (`entidad`, `idEntidad`, `usuario`, `vigilador`, `operacion`, `evento`, `modulo`)
VALUES
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`DBAdmin_Acceso_A_Planta`@`%`*/ /*!50003 TRIGGER `trg_doc_upd` AFTER UPDATE ON `documentos` FOR EACH ROW INSERT INTO `auditoria`
  (`entidad`, `idEntidad`, `usuario`, `vigilador`, `operacion`, `evento`, `modulo`)
VALUES
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`DBAdmin_Acceso_A_Planta`@`%`*/ /*!50003 TRIGGER `trg_doc_del` BEFORE DELETE ON `documentos` FOR EACH ROW INSERT INTO `auditoria`
  (`entidad`, `idEntidad`, `usuario`, `vigilador`, `operacion`, `evento`, `modulo`)
VALUES
...
INSERT INTO `movimientos` VALUES (1,0,1,1,'0003',NULL,'2026-02-06 12:24:50',0,'Motivos personales','1768','sfjhsryjyj',2,1,1,'dxfdxfdf',NULL,0,NULL,'gabrielt@donyeyo.com.ar','ailu'),(2,0,1,2,'0735',NULL,'2026-02-06 00:00:00',0,'Accidente o razones médicas','1768','',1,2,2,'fghfgh',NULL,0,NULL,'gabrielt@donyeyo.com.ar',''),(3,0,1,1,'0023',NULL,'2026-02-06 12:42:55',0,'Requerimiento laboral','1768','',1,4,3,'jhhhh',NULL,0,NULL,'gabrielt@donyeyo.com.ar',''),(4,0,1,1,'0735',NULL,'2026-02-06 00:00:00',0,'Accidente o razones médicas','1768','',1,4,4,'va al medico a sacarse una muela, despues va al ba',NULL,0,NULL,'gabrielt@donyeyo.com.ar',''),(5,0,1,1,'0005',NULL,'2026-02-06 00:00:00',0,'Accidente o razones médicas','1768',NULL,1,1,3,'dfgdfg',NULL,0,NULL,'gabrielt@donyeyo.com.ar',''),(6,0,1,1,'0735',NULL,'2026-02-06 00:00:00',0,'Requerimiento laboral','1768',NULL,1,2,3,'asdasd',NULL,0,NULL,'gabrielt@donyeyo.com.ar',''),(7,0,1,1,'0735',NULL,'2026-02-06 00:00:00',0,'Requerimiento laboral','1768','sds',1,1,3,'sadsad',NULL,0,NULL,'gabrielt@donyeyo.com.ar',''),(8,0,1,1,'0735',NULL,'2026-02-06 00:00:00',1,'Requerimiento laboral','1768',NULL,1,2,3,'wdswqadsqwas',NULL,0,NULL,'gabrielt@donyeyo.com.ar',''),(9,0,1,1,'0006',NULL,'2026-02-06 00:00:00',0,'Requerimiento laboral','1768','',1,1,3,'zxczdfdsfdgaaaa',NULL,0,NULL,'gabrielt@donyeyo.com.ar',''),(10,0,1,1,'0009',NULL,'2026-02-06 00:00:00',0,'Accidente o razones médicas','1768','9',1,2,3,'sdfsdfsd',NULL,0,NULL,'gabrielt@donyeyo.com.ar',''),(11,0,1,1,'0005',NULL,'2026-02-06 00:00:00',0,'Requerimiento laboral','1768','10',1,1,3,'sadsad',NULL,0,NULL,'gabrielt@donyeyo.com.ar',''),(12,0,1,1,'0150',NULL,'2026-02-06 00:00:00',0,'Requerimiento laboral','1768','11',1,1,3,'asdsad',NULL,0,NULL,'gabrielt@donyeyo.com.ar',''),(13,0,1,1,'0005',NULL,'2026-02-06 00:00:00',0,'Accidente o razones médicas','1768','12',1,1,3,'ertert',NULL,0,NULL,'gabrielt@donyeyo.com.ar',''),(14,0,1,1,'0048',NULL,'2026-02-06 00:00:00',0,'Motivos personales','1768','',1,1,3,'dssadasd',NULL,0,NULL,'gabrielt@donyeyo.com.ar',''),(15,0,1,1,'1543',NULL,'2026-02-06 00:00:00',1,'Motivos personales','1768','14',1,1,3,'sdsd',NULL,0,NULL,'gabrielt@donyeyo.com.ar',''),(16,0,1,1,'1767',NULL,'2026-02-06 00:00:00',0,'Requerimiento laboral','1768','15',1,1,3,'sadsd',NULL,0,NULL,'gabrielt@donyeyo.com.ar',''),(17,0,1,1,'1752',NULL,'2026-02-06 00:00:00',0,'Requerimiento laboral','1768','16',1,4,3,'adsdasd',NULL,0,NULL,'gabrielt@donyeyo.com.ar',''),(18,0,1,1,'1747',NULL,'2026-02-06 12:44:09',0,'Motivos personales','1768','',1,1,3,'e brterret ert ert',NULL,0,NULL,'gabrielt@donyeyo.com.ar',''),(19,0,1,1,'1533',NULL,'2026-02-06 00:00:00',0,'Motivos personales','1768','algo algo',1,4,2,'gggg',NULL,0,NULL,'gabrielt@donyeyo.com.ar',''),(20,0,1,1,'1058',NULL,'2026-02-06 00:00:00',0,'Motivos personales','1768',NULL,1,1,2,NULL,NULL,0,NULL,'gabrielt@donyeyo.com.ar',''),(21,0,1,1,'1545',NULL,'2026-02-06 00:00:00',0,'Motivos personales','1768',NULL,1,1,2,NULL,NULL,0,NULL,'gabrielt@donyeyo.com.ar',''),(22,0,1,1,'1544',NULL,'2026-02-06 00:00:00',0,'Requerimiento laboral','1768','',1,1,3,'gfgfg',NULL,0,NULL,'gabrielt@donyeyo.com.ar',''),(23,0,1,1,'1586',NULL,'2026-02-06 00:00:00',0,'Motivos personales','1768',NULL,1,1,3,'gfg',NULL,0,NULL,'gabrielt@donyeyo.com.ar',''),(24,0,1,1,'1543',NULL,'2026-02-06 00:00:00',0,'Motivos personales','1768',NULL,1,1,3,'dsfsdf',NULL,0,NULL,'gabrielt@donyeyo.com.ar',''),(25,0,1,1,'1541',NULL,'2026-02-06 00:00:00',0,'Motivos personales','1768',NULL,1,1,3,'hgjghj',NULL,0,NULL,'gabrielt@donyeyo.com.ar',''),(26,0,1,1,'0474',NULL,'2026-02-06 00:00:00',0,'Motivos personales','1768','',1,1,3,'ffff',NULL,0,NULL,'gabrielt@donyeyo.com.ar',''),(27,0,1,1,'1504',NULL,'2026-02-06 11:33:33',0,'Requerimiento laboral','1768','',1,1,2,'gfdfgdfg',NULL,0,NULL,'gabrielt@donyeyo.com.ar','');
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`DBAdmin_Acceso_A_Planta`@`%`*/ /*!50003 TRIGGER `trg_mov_before_insert` BEFORE INSERT ON `movimientos` FOR EACH ROW BEGIN
    SET NEW.id = NULL;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`DBAdmin_Acceso_A_Planta`@`%`*/ /*!50003 TRIGGER `trg_mov_ins` AFTER INSERT ON `movimientos` FOR EACH ROW INSERT INTO `auditoria`
  (`entidad`, `idEntidad`, `usuario`, `vigilador`, `operacion`, `evento`, `modulo`)
VALUES
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`DBAdmin_Acceso_A_Planta`@`%`*/ /*!50003 TRIGGER `trg_mov_upd` AFTER UPDATE ON `movimientos` FOR EACH ROW INSERT INTO `auditoria`
  (`entidad`, `idEntidad`, `usuario`, `vigilador`, `operacion`, `evento`, `modulo`)
VALUES
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`DBAdmin_Acceso_A_Planta`@`%`*/ /*!50003 TRIGGER `trg_mov_del` BEFORE DELETE ON `movimientos` FOR EACH ROW INSERT INTO `auditoria`
  (`entidad`, `idEntidad`, `usuario`, `vigilador`, `operacion`, `evento`, `modulo`)
VALUES
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
CREATE DEFINER=`DBAdmin_Acceso_A_Planta`@`%` FUNCTION `ProperCase`(p_str TEXT) RETURNS text CHARSET utf8mb4
    DETERMINISTIC
BEGIN
  RETURN p_str;
END ;;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
CREATE DEFINER=`DBAdmin_Acceso_A_Planta`@`%` PROCEDURE `sp_ObtenerObjetosPendientes`()
BEGIN
...
-- Dump completed on 2026-02-06 13:06:34
